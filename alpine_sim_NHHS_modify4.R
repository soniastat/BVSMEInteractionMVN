...
# Functions for simulating data and fitting NHHS-MVN-cov model
###################################################################
...
# Update theta
update_theta_NHHS_MVN_cov_modify <- function(Y, K, W, WTW, n_all_par,
                                          J, M, O,
                                          sigmasq_alpha = 100,
...
#######################################################################################
# Update Sigma
update_Sigma_NHHS_MVN_cov <- function(Y, n, W, theta_update, Psi_0, nu_0)
{
  # Residuals
...
update_lambdasq_beta_NHHS_MVN_cov2 <- function(beta_update,
                                               psi_beta_update,
                                               tausq_beta_update)
{
...
update_lambdasq_gamma_NHHS_MVN_cov2 <- function(gamma_update,
                                                psi_gamma_update,
                                                tausq_gamma_update)
{
...
update_lambdasq_delta_NHHS_MVN_cov2 <- function(J, M, K,
                                                delta_update,
                                                psi_delta_update,
                                                tausq_delta_update)
{
  scale_lambdasq_delta <- ((1 / psi_delta_update) + (delta_update^2 /
...
update_tausq_beta_NHHS_MVN_cov2 <- function(
    J, K,
    beta_update,
...
update_tausq_gamma_NHHS_MVN_cov2 <- function(M, K, gamma_update,
...
update_tausq_delta_NHHS_MVN_cov2 <- function(J, M, K,
                                             delta_update,
...
update_psi_beta_NHHS_MVN_cov2 <- function(lambdasq_beta_update)
{
...
update_psi_gamma_NHHS_MVN_cov2 <- function(lambdasq_gamma_update)
{
...
update_psi_delta_NHHS_MVN_cov2 <- function(lambdasq_delta_update)
{
...
# Update xi_beta
update_xi_beta_NHHS_MVN_cov <- function(J, tausq_beta_update)
{
...
# Update xi_gamma
update_xi_gamma_NHHS_MVN_cov <- function(M, tausq_gamma_update)
{
...
update_xi_delta_NHHS_MVN_cov <- function(J, M, tausq_delta_update)
{
...
# Update parameters for NHHS-MVN-cov model
fit_NHHS_MVN_cov_modify3 <- function(niter = 6000, burn_in = 1000, thin = 5,
                                 ...
                                 sigmasq_varphi = 10)
{
  ...
  for(s in 2:niter)
  {
    ...
    # theta_update
    theta_update_s <- update_theta_NHHS_MVN_cov_modify(Y, K, W, WTW, n_all_par,
                                                    J, M, O,
                                                    sigmasq_alpha = 100,
    ...
    # Sigma_update
    Sigma_update_s <- update_Sigma_NHHS_MVN_cov(Y, n, W, theta_update[s, , ], Psi_0, nu_0)
    Sigma_update[s, , ] <- Sigma_update_s



    # lambdasq_beta_update
    lambdasq_beta_update_s <- update_lambdasq_beta_NHHS_MVN_cov2(beta_update = beta_update[s, , ],
    ...
    # lambdasq_gamma_update
    lambdasq_gamma_update_s <- update_lambdasq_gamma_NHHS_MVN_cov2(gamma_update = gamma_update[s, , ],
    ...
    # lambdasq_delta_update
    lambdasq_delta_update_s <- update_lambdasq_delta_NHHS_MVN_cov2(J, M, K,
    ...
    # Update tausq_beta
    tausq_beta_update_s <- update_tausq_beta_NHHS_MVN_cov2(J, K,
    ...
    # Update tausq_gamma
    tausq_gamma_update_s <- update_tausq_gamma_NHHS_MVN_cov2(M, K,
    ...
    # Update tausq_delta
    tausq_delta_update_s <- update_tausq_delta_NHHS_MVN_cov2(J, M, K,
                                                                delta_update = delta_update[s, , ],
    ...
    # Update psi_beta
    psi_beta_update_s <- update_psi_beta_NHHS_MVN_cov2(lambdasq_beta_update = lambdasq_beta_update[s, , ])
    psi_beta_update[s, , ] <- psi_beta_update_s



    # Update psi_gamma
    psi_gamma_update_s <- update_psi_gamma_NHHS_MVN_cov2(lambdasq_gamma_update = lambdasq_gamma_update[s, , ])
    psi_gamma_update[s, , ] <- psi_gamma_update_s



    # Update psi_delta
    psi_delta_update_s <- update_psi_delta_NHHS_MVN_cov2(lambdasq_delta_update = lambdasq_delta_update[s, , ])
    psi_delta_update[s, , ] <- psi_delta_update_s



    # Update xi_beta
    xi_beta_update_s <- update_xi_beta_NHHS_MVN_cov(J, tausq_beta_update = tausq_beta_update[s, ])
    xi_beta_update[s] <- xi_beta_update_s



    # Update xi_gamma
    xi_gamma_update_s <- update_xi_gamma_NHHS_MVN_cov(M, tausq_gamma_update = tausq_gamma_update[s, ])
    xi_gamma_update[s] <- xi_gamma_update_s



    # Update xi_delta
    xi_delta_update_s <- update_xi_delta_NHHS_MVN_cov(J, M, tausq_delta_update = tausq_delta_update[s, ])
