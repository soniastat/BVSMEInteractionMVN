...
dir.create("/projects/soniast@colostate.edu/results_HHSSI_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HHSSI_modify3/modify3_HHSSI_cov_sample_", sample_id, ".rds")
