...
dir.create("/projects/soniast@colostate.edu/results_HHS_modify4_allvarsim_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HHS_modify4_allvarsim_elevated/modify4_allvarsim_elevated_HHS_cov_sample_", sample_id, ".rds")
