...
update_tausq_beta_BVS_HHS_MVN_cov1 <- function(J, K, beta_update, lambdasq_beta_update, xi_beta_update)
{
...
update_tausq_gamma_BVS_HHS_MVN_cov1 <- function(M, K, gamma_update, lambdasq_gamma_update, xi_gamma_update)
{
...
fit_BVS_HHS_MVN_cov_modify1 <- function(niter = 6000, burn_in = 1000, thin = 5,
                                ...
                                sigmasq_varphi = 10)
{
  ...
  for(s in 2:niter)
  {
    ...
    # theta_update
    theta_update_s <- update_theta_BVS_HHS_MVN_cov(Y, K, W, WTW, n_all_par,
                                                   J, M, O,
    ...
    # Update tausq_beta
    tausq_beta_update_s <- update_tausq_beta_BVS_HHS_MVN_cov1(J, K,
                                                             beta_update = beta_update[s, , ],
                                                             lambdasq_beta_update = lambdasq_beta_update[s, , ],
    ...
    # Update tausq_gamma
    tausq_gamma_update_s <- update_tausq_gamma_BVS_HHS_MVN_cov1(M, K,
                                                               gamma_update = gamma_update[s, , ],
                                                               lambdasq_gamma_update = lambdasq_gamma_update[s, , ],
