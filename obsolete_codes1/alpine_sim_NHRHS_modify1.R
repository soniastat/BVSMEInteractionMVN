...
# Update theta
update_theta_BVS_NHRHS_MVN_cov <- function(Y, K, W, WTW, n_all_par,
                                           J, M, O,
                                           c,
...
fit_BVS_NHRHS_MVN_cov_modify1 <- function(niter = 6000, burn_in = 1000, thin = 5,
                                  ...
                                  sigmasq_varphi = 10)
{
  ...
  for(s in 2:niter)
  {
    ...
    # theta_update
    theta_update_s <- update_theta_BVS_NHRHS_MVN_cov(Y, K, W, WTW, n_all_par,
                                                     J, M, O,
                                                     c,
