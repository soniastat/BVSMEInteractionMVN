...
# Testing codes for BVS-NHHS-SI-MVN-cov
...
theta_update_save <- tryCatch({
  ...
  res <- fit_BVS_NHHS_SI_MVN_cov_modify(
    niter = 6000, burn_in = 1000, thin = 5,
    n=n, K=K, Y=Y, W=W, WTW, n_all_par=n_all_par,
    J=J, M=M, O=O,
...
dir.create("results_NHHS_SI_modify", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("results_NHHS_SI_modify/_modify_NHHS_SI_cov_sample_", sample, ".rds")
...
# saveRDS(
#   theta_update_list,
#   file = "results/theta_update_NHHS_SI_cov_list.rds"
# )
#
#
...
#
# # seq 1 100 | xargs -n 1 -P 5 Rscript run_one_sample_NHHS_SI_cov_modify.R
#
#
# From terminal of magpie
# seq 1 100 | xargs -n 1 -P 10 /opt/R/4.5.0/lib/R/bin/Rscript run_one_sample_NHHS_SI_cov_modify.R
#
