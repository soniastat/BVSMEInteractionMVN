...
outfile <- paste0("results/HHS_SI_cov_sample_", sample, ".rds")
...
# saveRDS(
#   theta_update_list,
#   file = "results/theta_update_HHS_SI_cov_list.rds"
# )
#
#
...
#
# # seq 1 100 | xargs -n 1 -P 5 Rscript run_one_sample_HHS_SI_cov.R
#
#
#
