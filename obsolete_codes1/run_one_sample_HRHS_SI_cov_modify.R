...
# Testing codes for BVS-HRHS-SI-MVN-cov
...
theta_update_save <- tryCatch({
  ...
  res <- fit_BVS_HRHS_SI_MVN_cov_modify(niter=2, burn_in=0, thin=1,
...
dir.create("results_HRHS_SI_modify", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("results_HRHS_SI_modify/modify_HRHS_SI_cov_sample_", sample, ".rds")
...
# saveRDS(
#   theta_update_list,
#   file = "results/theta_update_HRHS_SI_list.rds"
# )
#
#
...
#
# # seq 1 100 | xargs -n 1 -P 5 Rscript run_one_sample_HRHS_SI_cov_modify.R
#
#
# From terminal of magpie
# seq 1 100 | xargs -n 1 -P 10 /opt/R/4.5.0/lib/R/bin/Rscript run_one_sample_HRHS_SI_cov_modify.R
#
