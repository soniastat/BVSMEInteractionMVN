...
source("/projects/soniast@colostate.edu/alpine_sim_HRHS_modify1.R")
...
theta_update_save <- tryCatch({
  ...
  res <- fit_BVS_HRHS_MVN_cov_modify1(
...
dir.create("/projects/soniast@colostate.edu/results_HRHS_modify1", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHS_modify1/modify1_HRHS_cov_sample_", sample_id, ".rds")
