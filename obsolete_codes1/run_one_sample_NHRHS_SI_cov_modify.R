...
dir.create("results_NHRHS_SI_modify", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("results_NHRHS_SI_modify/modify_NHRHS_SI_cov_sample_", sample, ".rds")
...
#
# # seq 1 100 | xargs -n 1 -P 5 Rscript run_one_sample_NHRHS_SI_cov_modify.R
#
#
#
