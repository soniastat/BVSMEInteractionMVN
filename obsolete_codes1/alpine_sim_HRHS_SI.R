...
# Update theta
update_theta_BVS_HRHS_SI_MVN_cov <- function(Y, K, W, n_all_par,
                                             J, M, O,
                                             c,
...
)
{
  ...
  V_theta <- as.matrix(bdiag(mat_var_alpha, var_beta, var_gamma,
...
fit_BVS_HRHS_SI_MVN_cov <- function(niter = 20, burn_in = 2, thin = 1,
                                    ...
                                    sigmasq_varphi = 10)
{
  ...
  for(s in 2:niter)
  {
    ...
    # theta_update
    theta_update_s <- update_theta_BVS_HRHS_SI_MVN_cov(Y, K, W, n_all_par,
                                                       J, M, O,
                                                       c = c,
