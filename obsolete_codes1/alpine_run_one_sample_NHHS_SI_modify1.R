...
source("/projects/soniast@colostate.edu/alpine_sim_NHHS_SI_modify1.R")
...
theta_update_save <- tryCatch({
  ...
  res <- fit_BVS_NHHS_SI_MVN_cov_modify1(
...
dir.create("/projects/soniast@colostate.edu/results_NHHS_SI_modify1", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHHS_SI_modify1/modify1_NHHS_SI_cov_sample_", sample_id, ".rds")
