...
# Functions for simulating data and fitting BVS-NHHS-SI-MVN-cov model
...
update_lambdasq_beta_BVS_NHHS_SI_MVN_cov1 <- function(J, K, beta_update, psi_beta_update, tausq_beta_update)
{
...
update_lambdasq_gamma_BVS_NHHS_SI_MVN_cov1 <- function(M, K, gamma_update, psi_gamma_update, tausq_gamma_update)
{
...
update_tausq_beta_BVS_NHHS_SI_MVN_cov1 <- function(J, K, beta_update, lambdasq_beta_update, xi_beta_update)
{
...
update_tausq_gamma_BVS_NHHS_SI_MVN_cov1 <- function(M, K, gamma_update, lambdasq_gamma_update, xi_gamma_update)
{
  ...
  for(m in 1:M)
  {
    for (k in 1:K)
    {
      sum_term_tausq_gamma <- sum_term_tausq_gamma + (gamma_update[m, k]^2 / (2 * lambdasq_gamma_update[m]))
    }
  }
...
update_psi_beta_BVS_NHHS_SI_MVN_cov1 <- function(J, lambdasq_beta_update)
{
...
update_psi_gamma_BVS_NHHS_SI_MVN_cov1 <- function(M, lambdasq_gamma_update)
{
...
update_psi_delta_BVS_NHHS_SI_MVN_cov1 <- function(J, M, lambdasq_delta_update)
{
...
fit_BVS_NHHS_SI_MVN_cov_modify1 <- function(niter = 20, burn_in = 2, thin = 1,
                                    ...
                                    sigmasq_varphi = 10)
{
  ...
  for(s in 2:niter)
  {
    ...
    lambdasq_beta_update_s <- update_lambdasq_beta_BVS_NHHS_SI_MVN_cov1(J, K,
    ...
    lambdasq_gamma_update_s <- update_lambdasq_gamma_BVS_NHHS_SI_MVN_cov1(M, K,
    ...
    # Update tausq_beta
    tausq_beta_update_s <- update_tausq_beta_BVS_NHHS_SI_MVN_cov1(J, K,
                                                                 beta_update = beta_update[s, , ],
    ...
    # Update tausq_gamma
    tausq_gamma_update_s <- update_tausq_gamma_BVS_NHHS_SI_MVN_cov1(M, K,
                                                                   gamma_update = gamma_update[s, , ],
    ...
    # Update psi_beta
    psi_beta_update_s <- update_psi_beta_BVS_NHHS_SI_MVN_cov1(J,
                                                             lambdasq_beta_update = lambdasq_beta_update[s, ])
    psi_beta_update[s, ] <- psi_beta_update_s


    # Update psi_gamma
    psi_gamma_update_s <- update_psi_gamma_BVS_NHHS_SI_MVN_cov1(M,
                                                               lambdasq_gamma_update = lambdasq_gamma_update[s, ])
    psi_gamma_update[s, ] <- psi_gamma_update_s


    # Update psi_delta
    psi_delta_update_s <- update_psi_delta_BVS_NHHS_SI_MVN_cov1(J, M,
                                                               lambdasq_delta_update = lambdasq_delta_update[s, ])
