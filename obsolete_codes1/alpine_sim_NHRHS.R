...
# Update theta
update_theta_BVS_NHRHS_MVN_cov <- function(Y, K, W, n_all_par,
                                           J, M, O,
                                           c,
...
fit_BVS_NHRHS_MVN_cov <- function(niter = 20, burn_in = 2, thin = 1,
                                  ...
                                  sigmasq_varphi = 10)
{
  ...
  for(s in 2:niter)
  {
    ...
    # theta_update
    theta_update_s <- update_theta_BVS_NHRHS_MVN_cov(Y, K, W, n_all_par,
                                                     J, M, O,
                                                     c,
