...
dir.create("/projects/soniast@colostate.edu/results_HRHSSI_modify4_allvarreal_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHSSI_modify4_allvarreal_elevated/modify4_allvarreal_elevated_HRHSSI_cov_sample_", sample_id, ".rds")
