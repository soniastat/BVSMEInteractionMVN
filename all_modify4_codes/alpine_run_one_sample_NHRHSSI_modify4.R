...
dir.create("/projects/soniast@colostate.edu/results_NHRHSSI_modify4", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHRHSSI_modify4/modify4_NHRHSSI_cov_sample_", sample_id, ".rds")
