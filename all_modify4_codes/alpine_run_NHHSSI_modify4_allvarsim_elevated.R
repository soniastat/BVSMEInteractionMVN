...
source("/projects/soniast@colostate.edu/alpine_sim_NHHSSI_modify4.R")
...
theta_update_save6 <- tryCatch({
  ...
  res <- fit_NHHSSI_MVN_cov_modify3(
...
dir.create("/projects/soniast@colostate.edu/results_NHHSSI_modify4_allvarsim_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHHSSI_modify4_allvarsim_elevated/modify4_allvarsim_elevated_NHHSSI_cov_sample_", sample_id, ".rds")
