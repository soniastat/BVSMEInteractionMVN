...
dir.create("/projects/soniast@colostate.edu/results_sample_data_1301_alvarsim_modify4", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_sample_data_1301_alvarsim_modify4/modify4_sample_data_1301_alvarsim_", sample_id, ".rds")
