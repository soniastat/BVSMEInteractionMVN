...
dir.create("/projects/soniast@colostate.edu/results_sample_data_allvarsim_modify4_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_sample_data_allvarsim_modify4_elevated/modify4_elevated_sample_data_1301_allvarsim_", sample_id, ".rds")
