...
source("/projects/soniast@colostate.edu/alpine_sim_NHRHS_modify4.R")
...
dir.create("/projects/soniast@colostate.edu/results_NHRHS_modify4_allvarsim_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHRHS_modify4_allvarsim_elevated/modify4_allvarsim_elevated_NHRHS_cov_sample_", sample_id, ".rds")
