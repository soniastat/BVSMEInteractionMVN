...
dir.create("/projects/soniast@colostate.edu/results_HHS_simdata_n1301_modify4", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HHS_simdata_n1301_modify4/modify4_n1301_HHS_cov_sample_", sample_id, ".rds")
