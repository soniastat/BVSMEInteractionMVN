...
source("/projects/soniast@colostate.edu/alpine_sim_HRHSSI_modify4.R")
...
theta_update_save4 <- tryCatch({
  ...
  res <- fit_HRHSSI_MVN_cov_modify3(
...
dir.create("/projects/soniast@colostate.edu/results_HRHSSI_modify4_allvarsim_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHSSI_modify4_allvarsim_elevated/modify4_allvarsim_elevated_HRHSSI_cov_sample_", sample_id, ".rds")
