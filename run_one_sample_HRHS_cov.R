...
theta_update_save <- tryCatch({
  ...
  res <- fit_BVS_HRHS_MVN_cov(niter=6000, burn_in=1000, thin=5,
...
outfile <- paste0("results/HRHS_cov_sample_", sample, ".rds")
...
#
# # seq 1 100 | xargs -n 1 -P 5 Rscript run_one_sample_HRHS_cov.R
#
#
#
