...
dir.create("/projects/soniast@colostate.edu/results_HRHS_modify4", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHS_modify4/modify4_HRHS_cov_sample_", sample_id, ".rds")
