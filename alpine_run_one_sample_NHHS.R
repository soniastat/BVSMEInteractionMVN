...
source("/projects/soniast@colostate.edu/alpine_sim_NHHS.R")
...
theta_update_save <- tryCatch({
  ...
  res <- fit_BVS_NHHS_MVN_cov(
    ...
    n = n, K = K, Y = Y, W = W, n_all_par = n_all_par, J = J,
    M = M, O = O,
...
dir.create("/projects/soniast@colostate.edu/results_NHHS", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHHS/NHHS_cov_sample_", sample_id, ".rds")
