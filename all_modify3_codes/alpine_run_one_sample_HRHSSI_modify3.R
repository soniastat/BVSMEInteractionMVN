...
dir.create("/projects/soniast@colostate.edu/results_HRHSSI_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHSSI_modify3/modify3_HRHSSI_cov_sample_", sample_id, ".rds")
