...
source("/projects/soniast@colostate.edu/alpine_sim_HRHSSI_modify3.R")
...
dir.create("/projects/soniast@colostate.edu/results_HRHSSI_simdata_n1301_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHSSI_simdata_n1301_modify3/modify3_n1301_HRHSSI_cov_sample_", sample_id, ".rds")
