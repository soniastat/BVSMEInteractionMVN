...
dir.create("/projects/soniast@colostate.edu/results_sample_data_1301_alvarreal_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_sample_data_1301_alvarreal_modify3/modify3_sample_data_1301_alvarreal_", sample_id, ".rds")
