...
source("/projects/soniast@colostate.edu/alpine_sim_HHS_modify3.R")
...
############################
# Simulate one dataset all var simulated
############################

set.seed(23444 + sample_id)
sim_data <- Sim_data_BVS_real_sim_var(
  K = K,
  n = n,
  J = J,
  M = M,
...
dir.create("/projects/soniast@colostate.edu/results_sample_data_1301_alvarsim_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_sample_data_1301_alvarsim_modify3/modify3_sample_data_1301_alvarsim_", sample_id, ".rds")
