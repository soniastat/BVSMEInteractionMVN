...
source("/projects/soniast@colostate.edu/alpine_sim_HRHS_modify3.R")
...
dir.create("/projects/soniast@colostate.edu/results_HRHS_simdata_n1301_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHS_simdata_n1301_modify3/modify3_n1301_HRHS_cov_sample_", sample_id, ".rds")
