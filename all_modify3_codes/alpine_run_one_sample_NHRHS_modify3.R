...
dir.create("/projects/soniast@colostate.edu/results_NHRHS_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHRHS_modify3/modify3_NHRHS_cov_sample_", sample_id, ".rds")
