...
dir.create("/projects/soniast@colostate.edu/results_NP_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NP_modify3/modify3_NP_cov_sample_", sample_id, ".rds")
