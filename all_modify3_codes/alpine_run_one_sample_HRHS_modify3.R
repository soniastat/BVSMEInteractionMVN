...
dir.create("/projects/soniast@colostate.edu/results_HRHS_modify3", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHS_modify3/modify3_HRHS_cov_sample_", sample_id, ".rds")
