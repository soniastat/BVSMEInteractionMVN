...
source("/projects/soniast@colostate.edu/alpine_sim_NHHS_SI.R")
...
dir.create("/projects/soniast@colostate.edu/results_NHHS_SI", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHHS_SI/NHHS_SI_cov_sample_", sample_id, ".rds")
