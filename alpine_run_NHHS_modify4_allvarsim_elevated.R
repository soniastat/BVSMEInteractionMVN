...
source("/projects/soniast@colostate.edu/alpine_sim_NHHS_modify4.R")
...
dir.create("/projects/soniast@colostate.edu/results_NHHS_modify4_allvarsim_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHHS_modify4_allvarsim_elevated/modify4_allvarsim_elevated_NHHS_cov_sample_", sample_id, ".rds")
