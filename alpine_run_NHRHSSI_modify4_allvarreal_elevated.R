...
# Testing codes for BVS-NHRHS_SI-MVN-cov
...
dir.create("/projects/soniast@colostate.edu/results_NHRHSSI_modify4_allvarreal_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NHRHSSI_modify4_allvarreal_elevated/modify4_allvarreal_elevated_NHRHSSI_cov_sample_", sample_id, ".rds")
