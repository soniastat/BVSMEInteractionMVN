...
dir.create("/projects/soniast@colostate.edu/results_HRHSSI_modify4", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHSSI_modify4/modify4_HRHSSI_cov_sample_", sample_id, ".rds")
