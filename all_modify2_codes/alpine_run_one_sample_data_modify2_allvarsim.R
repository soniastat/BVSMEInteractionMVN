...
source("/projects/soniast@colostate.edu/alpine_sim_HHS_modify2.R")
...
dir.create("/projects/soniast@colostate.edu/results_sample_data_1301_alvarsim", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_sample_data_1301_alvarsim/sample_data_1301_alvarsim_", sample_id, ".rds")
