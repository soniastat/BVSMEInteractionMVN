...
source("/projects/soniast@colostate.edu/alpine_sim_HRHS_SI_modify2.R")
...
dir.create("/projects/soniast@colostate.edu/results_HRHS_SI_modify2", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHS_SI_modify2/modify2_HRHS_SI_cov_sample_", sample_id, ".rds")
