...
dir.create("/projects/soniast@colostate.edu/results_sample_data_1301_alvarreal", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_sample_data_1301_alvarreal/sample_data_1301_alvarreal_", sample_id, ".rds")
