...
dir.create("/projects/soniast@colostate.edu/results_HHS_modify2", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HHS_modify2/modify2_HHS_cov_sample_", sample_id, ".rds")
