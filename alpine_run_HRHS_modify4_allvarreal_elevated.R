...
dir.create("/projects/soniast@colostate.edu/results_HRHS_modify4_allvarreal_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_HRHS_modify4_allvarreal_elevated/modify4_allvarreal_elevated_HRHS_cov_sample_", sample_id, ".rds")
