...
#######################################################
# Fit the BVS-NHRHS-MVN-cov model

start_time_BVS_NHRHS_MVN_cov <- Sys.time()
set.seed(3567)
res_all_par_BVS_NHRHS_MVN_cov <- fit_BVS_NHRHS_MVN_cov(
...
end_time_BVS_NHRHS_MVN_cov <- Sys.time()
end_time_BVS_NHRHS_MVN_cov - start_time_BVS_NHRHS_MVN_cov

# save(res_all_par_BVS_NHRHS_MVN_cov, file = "exposome_data_analysis/res_n1301_O6_M17_J44_K5_6000ite_1000burn_5thin_BVSNHRHSMVNcov_postexpo.rda")
# load(file = "exposome_data_analysis/res_n1301_O6_M17_J44_K5_6000ite_1000burn_5thin_BVSNHRHSMVNcov_postexpo.rda")


###########################################################################################

start_time_BVS_NHRHS_MVN_cov_chain2 <- Sys.time()
set.seed(433578)
res_all_par_BVS_NHRHS_MVN_cov_chain2 <- fit_BVS_NHRHS_MVN_cov(
  niter = 6000, burn_in = 1000, thin = 5,
  n = n, K = K, Y = Y, W = W, n_all_par = n_all_par, J = J, M = M, O,
  c = 2.5,
  theta_init = matrix(-0.5, nrow = n_all_par, ncol = K),
...
end_time_BVS_NHRHS_MVN_cov_chain2 <- Sys.time()
end_time_chain2 - start_time_BVS_NHRHS_MVN_cov_chain2

# save(res_all_par_BVS_NHRHS_MVN_cov_chain2, file = "exposome_data_analysis/res_n1301_O6_M17_J44_K5_6000ite_1000burn_5thin_BVSNHRHSMVNcov_postexpo_chain2.rda")
# load(file = "exposome_data_analysis/res_n1301_O6_M17_J44_K5_6000ite_1000burn_5thin_BVSNHRHSMVNcov_postexpo_chain2.rda")


#######################################################

start_time_BVS_NHRHS_MVN_cov_chain3 <- Sys.time()
set.seed(987656656)
res_all_par_BVS_NHRHS_MVN_cov_chain3 <- fit_BVS_NHRHS_MVN_cov(
  niter = 6000, burn_in = 1000, thin = 5,
  n = n, K = K, Y = Y, W = W, n_all_par = n_all_par, J = J, M = M, O,
  c = 2.5,
...
end_time_BVS_NHRHS_MVN_cov_chain3 <- Sys.time()
end_time_BVS_NHRHS_MVN_cov_chain3 - start_time_BVS_NHRHS_MVN_cov_chain3

# save(res_all_par_BVS_NHRHS_MVN_cov_chain3, file = "exposome_data_analysis/res_n1301_O6_M17_J44_K5_6000ite_1000burn_5thin_BVSNHRHSMVNcov_postexpo_chain3.rda")
# load(file = "exposome_data_analysis/res_n1301_O6_M17_J44_K5_6000ite_1000burn_5thin_BVSNHRHSMVNcov_postexpo_chain3.rda")
