...
# for multivariate normal response (BVS-HRHS-MVN)
...
# Update theta
update_theta_BVS_HRHS_MVN <- function(Y, K, W, n_all_par,
                         J, M,
                         c,
...
# Update Sigma
update_Sigma_BVS_HRHS_MVN <- function(Y, n, W, theta_update, Psi_0, nu_0)
{
  # Residuals
...
update_lambdasq_beta_BVS_HRHS_MVN <- function(c, J, K, beta_update, psi_beta_update, tausq_beta_update,
...
update_lambdasq_gamma_BVS_HRHS_MVN <- function(c, M, K, gamma_update, psi_gamma_update,
                                  tausq_gamma_update,
...
update_lambdasq_delta_BVS_HRHS_MVN <- function(c, J, M, K, delta_update, psi_delta_update,
                                  tausq_delta_update,
...
update_tausq_beta_BVS_HRHS_MVN <- function(c, J, K, beta_update,
...
update_tausq_gamma_BVS_HRHS_MVN <- function(c, M, K, gamma_update,
...
update_tausq_delta_BVS_HRHS_MVN <- function(c, J, M, K, delta_update, xi_delta_update,
...
update_psi_beta_BVS_HRHS_MVN <- function(J, K, lambdasq_beta_update)
{
...
update_psi_gamma_BVS_HRHS_MVN <- function(M, K, lambdasq_gamma_update)
{
...
update_psi_delta_BVS_HRHS_MVN <- function(J, M, K, lambdasq_delta_update)
{
...
# Update xi_beta
update_xi_beta_BVS_HRHS_MVN <- function(J, tausq_beta_update)
{
...
# Update xi_gamma
update_xi_gamma_BVS_HRHS_MVN <- function(M, tausq_gamma_update)
{
...
# Update xi_delta
update_xi_delta_BVS_HRHS_MVN <- function(J, M, tausq_delta_update)
{
  # Use more informative prior (xi_gamma ~ IG(15, 3))
...
#' Update parameters for BVS-HRHS-MVN model
#' @export
fit_BVS_HRHS_MVN <- function(niter = 20, burn_in = 2, thin = 1,
                            ...
                            accept_tausq_delta_init = rep(1, times = J*M))
{
  ...
  for(s in 2:niter)
  {
    ...
    # theta_update
    theta_update_s <- update_theta_BVS_HRHS_MVN(Y, K, W, n_all_par,
                                   J, M,
                                   c = c,
    ...
    # Sigma_update
    Sigma_update_s <- update_Sigma_BVS_HRHS_MVN(Y, n, W, theta_update[s, , ], Psi_0, nu_0)
    Sigma_update[s, , ] <- Sigma_update_s


    # lambdasq_beta_update
    lambdasq_beta_update_s <- update_lambdasq_beta_BVS_HRHS_MVN(c, J, K,
    ...
    lambdasq_gamma_update_s <- update_lambdasq_gamma_BVS_HRHS_MVN(c, M, K,
    ...
    # lambdasq_delta_update
    lambdasq_delta_update_s <- update_lambdasq_delta_BVS_HRHS_MVN(c, J, M, K,
    ...
    # Update tausq_beta
    tausq_beta_update_s <- update_tausq_beta_BVS_HRHS_MVN(c, J, K,
                                             beta_update = beta_update[s, , ],
                                             lambdasq_beta_update = lambdasq_beta_update[s, , ],
    ...
    # Update tausq_gamma
    tausq_gamma_update_s <- update_tausq_gamma_BVS_HRHS_MVN(c, M, K,
                                               gamma_update = gamma_update[s, , ],
                                               lambdasq_gamma_update = lambdasq_gamma_update[s, , ],
    ...
    # Update tausq_delta
    tausq_delta_update_s <- update_tausq_delta_BVS_HRHS_MVN(c, J, M, K,
                                               delta_update = delta_update[s, , ],
    ...
    # Update psi_beta
    psi_beta_update_s <- update_psi_beta_BVS_HRHS_MVN(J, K,
                                         lambdasq_beta_update = lambdasq_beta_update[s, , ])
    psi_beta_update[s, , ] <- psi_beta_update_s


    # Update psi_gamma
    psi_gamma_update_s <- update_psi_gamma_BVS_HRHS_MVN(M, K,
                                           lambdasq_gamma_update = lambdasq_gamma_update[s, , ])
    psi_gamma_update[s, , ] <- psi_gamma_update_s


    # Update psi_delta
    psi_delta_update_s <- update_psi_delta_BVS_HRHS_MVN(J, M, K,
                                           lambdasq_delta_update = lambdasq_delta_update[s, , ])
    psi_delta_update[s, , ] <- psi_delta_update_s


    # Update xi_beta
    xi_beta_update_s <- update_xi_beta_BVS_HRHS_MVN(J, tausq_beta_update = tausq_beta_update[s, ])
    xi_beta_update[s] <- xi_beta_update_s


    # Update xi_gamma
    xi_gamma_update_s <- update_xi_gamma_BVS_HRHS_MVN(M, tausq_gamma_update = tausq_gamma_update[s, ])
    xi_gamma_update[s] <- xi_gamma_update_s


    # Update xi_delta
    xi_delta_update_s <- update_xi_delta_BVS_HRHS_MVN(J, M, tausq_delta_update = tausq_delta_update[s, ])
