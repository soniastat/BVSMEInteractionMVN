...
source("/projects/soniast@colostate.edu/alpine_sim_NP_modify.R")
...
dir.create("/projects/soniast@colostate.edu/results_NP_modify", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NP_modify/modify_NP_cov_sample_", sample_id, ".rds")
