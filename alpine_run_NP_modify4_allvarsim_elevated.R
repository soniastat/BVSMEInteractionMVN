...
dir.create("/projects/soniast@colostate.edu/results_NP_modify4_allvarsim_elevated", recursive=TRUE, showWarnings=FALSE)

outfile <- paste0("/projects/soniast@colostate.edu/results_NP_modify4_allvarsim_elevated/modify4_allvarsim_elevated_NP_cov_sample_", sample_id, ".rds")
