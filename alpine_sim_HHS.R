...
# Functions for simulating data and fitting BVS-HHS-MVN-cov model
...
# Update theta
update_theta_BVS_HHS_MVN_cov <- function(Y, K, W, n_all_par,
                                         J, M, O,
...
update_tausq_gamma_BVS_HHS_MVN_cov <- function(M, K, gamma_update, lambdasq_gamma_update, xi_gamma_update)
{
...
fit_BVS_HHS_MVN_cov <- function(niter = 20, burn_in = 2, thin = 1,
                                ...
                                sigmasq_varphi = 10)
{
  ...
  for(s in 2:niter)
  {
    ...
    # theta_update
    theta_update_s <- update_theta_BVS_HHS_MVN_cov(Y, K, W, n_all_par,
                                                   J, M, O,
    ...
    # Update tausq_beta
    tausq_beta_update_s <- update_tausq_beta_BVS_HHS_MVN_cov(J, K,
                                                             beta_update = beta_update[s, , ],
                                                             lambdasq_beta_update = lambdasq_beta_update[s, , ],
    ...
    # Update tausq_gamma
    tausq_gamma_update_s <- update_tausq_gamma_BVS_HHS_MVN_cov(M, K,
                                                               gamma_update = gamma_update[s, , ],
                                                               lambdasq_gamma_update = lambdasq_gamma_update[s, , ],
